...
func TestTerminalSessions_RemoveIfHubInitiated(t *testing.T) {
	t.Run("returns_false_when_missing", testRemoveIfHubInitiatedMissingSession)
	t.Run("hub_initiated_close_returns_alreadyClosed_false", testRemoveIfHubInitiatedHubInitiatedClose)
	t.Run("agent_initiated_then_remove_returns_alreadyClosed_true", testRemoveIfHubInitiatedAgentInitiatedThenRemove)
}

func testRemoveIfHubInitiatedMissingSession(t *testing.T) {
	ts := NewTerminalSessions()
...
func testRemoveIfHubInitiatedHubInitiatedClose(t *testing.T) {
	ts := NewTerminalSessions()
...
func testRemoveIfHubInitiatedAgentInitiatedThenRemove(t *testing.T) {
	ts := NewTerminalSessions()
